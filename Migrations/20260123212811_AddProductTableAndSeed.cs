        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnitPriceText = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Spring tale, ibe pork shoulder, thai basil", "/images/foods/bun_bo_hue.png", true, "Bún Bò Huế", 50000, 1 },
                    { 2, "Shrimp, rice noodles, hcoi, bacon", "/images/foods/pho_bo.png", true, "Phở Bò", 50000, 2 },
                    { 3, "Stemed pork, iba pork, hsiu, thai basil", "/images/foods/pho_ga.png", true, "Phở Gà", 50000, 3 },
